...
if ( apply_filters( 'woocommerce_checkout_show_terms', true ) && function_exists( 'wc_terms_and_conditions_checkbox_enabled' ) ) {
	...
	<div class="woocommerce-terms-and-conditions-wrapper">
		...
		<div class="checkbox-form" style="margin-bottom:24px !important;">
			<input type="checkbox" name="terms" <?php checked( apply_filters( 'woocommerce_terms_is_checked_default', isset( $_POST['terms'] ) ), true ); // WPCS: input var ok, csrf ok. ?> id="terms" />
			<label for="terms">
				Ho letto e accetto la <a href="<?php echo esc_url( home_url( '/' ) ); ?>privacy-policy" target="_blank">Privacy Policy</a>
			</label>
		</div>
		<div class="clear"></div>
