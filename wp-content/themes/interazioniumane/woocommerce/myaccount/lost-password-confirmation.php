...
<div class="login-beauty--image">
	<img src="<?php echo get_template_directory_uri(); ?>/assets/img/auth/password-sent.jpg" class="login-beauty--image__img" alt="Registrati su Interazioni Umane" />
</div>
...
<div class="beautiful-forms">
	...
	<h2 class="beautiful-forms--title">Controlla la tua mail!</h2><br>
