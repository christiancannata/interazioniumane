...
<?php foreach ( $get_addresses as $name => $address_title ) : ?>
	...
	<div class="woocommerce-Address">
		<header class="woocommerce-Address-title">
			...
			<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', $name ) ); ?>" class="arrow-link"><?php echo $address ? esc_html__( 'Edit', 'woocommerce' ) : esc_html__( 'Add', 'woocommerce' ); ?></a>
		</header>
		<address>
			<?php
