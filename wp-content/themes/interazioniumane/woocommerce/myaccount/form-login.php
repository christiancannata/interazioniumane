...
<div class="login-beauty--image">
	<img src="<?php echo get_template_directory_uri(); ?>/assets/img/auth/register.jpg" class="login-beauty--image__img" alt="Registrati su Interazioni Umane" />
</div>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<div class="checkbox-form form-agree">
					...
					<label class="grey woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">Ricordami</label>
				</div>

				<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
				<button type="submit" class="dstr-button dstr-button-primary" name="login" value="<?php esc_attr_e( 'Accedi', 'woocommerce' ); ?>"><?php esc_html_e( 'Accedi', 'woocommerce' ); ?></button>
			</p>
	...
	<div class="check-register-form">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<p class="woocommerce-form-row form-row form-buttons">
				...
				<button type="submit" class="dstr-button dstr-button-primary" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
			</p>
