...
<div class="beautiful-forms">
	...
	<div class="password-form">
		<h2 class="beautiful-forms--title">Hai perso la tua password?</h2>
		<p class="beautiful-forms--message">Niente paura! Inserisci la tua email, riceverai un link per generarne una nuova.</p>
...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row form-row">
		...
		<button style="margin-top: 16px;" type="submit" class="dstr-button dstr-button-primary" value="<?php esc_attr_e( 'Reset password', 'woocommerce' ); ?>"><?php esc_html_e( 'Recupera password', 'woocommerce' ); ?></button>
	</p>
