...
function hideCV() {
  ...
  var noCV = jQuery('.hide-curriculum');
  if (noCV.length) {
    jQuery('.hide-if-false').hide();
    jQuery('#lettera_presentazione_field').hide();
    jQuery('#lettera_presentazione_field').remove();
    jQuery('#cv_upload_field').hide();
    jQuery('#cv_upload_field').remove();
