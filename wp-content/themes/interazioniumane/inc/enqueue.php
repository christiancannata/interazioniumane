...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		$css_version = $theme_version . '.' . filemtime( get_template_directory() . '/assets/css/main.css' );
		wp_enqueue_style( 'understrap-styles', get_template_directory_uri() . '/assets/css/main.css', array(), $css_version );
