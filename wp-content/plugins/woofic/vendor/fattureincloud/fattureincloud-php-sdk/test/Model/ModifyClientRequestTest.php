 ...
 *
 * @category    Class
 * @description The values of the client to modify. At first level it works in delta mode.
 * @package     FattureInCloud
 * @author   Fatture In Cloud API team
 * @link     https://fattureincloud.it
 */
class ModifyClientRequestTest extends TestCase
{
    public $array = [];
    public $object;
