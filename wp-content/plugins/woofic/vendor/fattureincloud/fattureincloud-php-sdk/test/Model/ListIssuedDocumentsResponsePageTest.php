<?php
/**
 * ListIssuedDocumentsResponsePageTest
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ListIssuedDocumentsResponsePageTest Class Doc Comment
 *
 * @category    Class
 * @description ListIssuedDocumentsResponsePage
 * @package     FattureInCloud
 * @author   Fatture In Cloud API team
 * @link     https://fattureincloud.it
 */
class ListIssuedDocumentsResponsePageTest extends TestCase
{
    public $array = [];
    public $object;
    ...
    public function setUp(): void
    {
        ...
        $this->object = ObjectSerializer::deserialize($json, '\FattureInCloud\Model\ListIssuedDocumentsResponsePage');
    }
    ...
    /**
     * Test "ListIssuedDocumentsResponsePage"
     */
    public function testListIssuedDocumentsResponsePage()
    {
