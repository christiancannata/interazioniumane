<?php
/**
 * GetNewIssuedDocumentTotalsRequestTest
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * GetNewIssuedDocumentTotalsRequestTest Class Doc Comment
 *
 * @category    Class
 * @description GetNewIssuedDocumentTotalsRequest
 * @package     FattureInCloud
 * @author   Fatture In Cloud API team
 * @link     https://fattureincloud.it
 */
class GetNewIssuedDocumentTotalsRequestTest extends TestCase
{
    public $array = [];
    public $object;
    ...
    public function setUp(): void
    {
        ...
        $this->object = ObjectSerializer::deserialize($json, '\FattureInCloud\Model\GetNewIssuedDocumentTotalsRequest');
    }
     ...
     */
    public function testGetNewIssuedDocumentTotalsRequest()
    {
