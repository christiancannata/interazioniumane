<?php
/**
 * GetExistingIssuedDocumentTotalsRequestTest
 *
 * PHP version 7.3
 *
 * @category Class
 ...
 *
 * @category    Class
 * @description GetExistingIssuedDocumentTotalsRequest
 * @package     FattureInCloud
 * @author   Fatture In Cloud API team
 * @link     https://fattureincloud.it
 */
class GetExistingIssuedDocumentTotalsRequestTest extends TestCase
{
    public $array = [];
    public $object;
