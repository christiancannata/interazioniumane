...
class IssuedDocumentEiData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets payment_method
     *
     * @param string|null $payment_method E-invoice payment method [required for e-invoices](see https://www.fatturapa.gov.it/export/documenti/fatturapa/v1.2.2/Rappresentazione_Tabellare_FattOrdinaria_V1.2.2.pdf for the accepted values of ModalitaPagamento)
     *
     * @return self
     */
