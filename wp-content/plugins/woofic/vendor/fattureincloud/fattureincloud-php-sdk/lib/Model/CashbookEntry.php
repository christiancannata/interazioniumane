...
class CashbookEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param string|null $id Cashbook id
     *
     * @return self
     */
     ...
     * Sets entity_name
     *
     * @param string|null $entity_name Cashbook entity name
     *
     * @return self
     */
     ...
     * Sets amount_in
     *
     * @param float|null $amount_in [Only for cashbook entry in] Cashbook total amount in
     *
     * @return self
     */
     ...
     * Sets amount_out
     *
     * @param float|null $amount_out [Only for cashbook entry out] Cashbook total amount out
     *
     * @return self
     */
