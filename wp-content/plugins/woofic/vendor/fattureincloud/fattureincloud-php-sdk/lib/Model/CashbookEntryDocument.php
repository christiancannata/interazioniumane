...
/**
 * CashbookEntryDocument Class Doc Comment
 *
 * @category Class
 * @package  FattureInCloud
 * @author   Fatture In Cloud API team
 ...
 */
class CashbookEntryDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashbookEntry_document';
     ...
     * Sets id
     *
     * @param int|null $id Cashbook related document id
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Cashbook related document type
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string|null $path Cashbook related document path
     *
     * @return self
     */
