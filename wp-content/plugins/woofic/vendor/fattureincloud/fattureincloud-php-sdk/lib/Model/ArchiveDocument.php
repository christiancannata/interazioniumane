...
class ArchiveDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param int|null $id Archive document id
     *
     * @return self
     */
     ...
     * Sets attachment_url
     *
     * @param string|null $attachment_url [Temporary] [Read Only] Archive Document url of the attached file
     *
     * @return self
     */
     ...
     *
     * @param string|null $attachment_token [Write Only]  [Required] Archive document attachment token returned by POST /archive/attachment
     *
     * @return self
     */
