...
class EInvoiceRejectionReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets reason
     *
     * @param string|null $reason E-invoice rejection reason
     *
     * @return self
     */
    ...
    public function setSolution($solution)
    {
        if (is_null($solution)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('solution', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets code
     *
     * @param string|null $code E-invoice rejection error code
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date E-invoice rejection date
     *
     * @return self
     */
