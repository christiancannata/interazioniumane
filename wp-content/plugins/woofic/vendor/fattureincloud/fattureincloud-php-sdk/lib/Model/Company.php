...
class Company implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets access_token
     *
     * @param string|null $access_token Company authentication token for this company. [Only if type=company]
     *
     * @return self
     */
     ...
     *
     * @param \FattureInCloud\Model\ControlledCompany[]|null $controlled_companies Company list of controlled companies [Only if type=accountant]
     *
     * @return self
     */
     ...
     * Sets tax_code
     *
     * @param string|null $tax_code Company tax code
     *
     * @return self
     */
