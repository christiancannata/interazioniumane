...
class PaymentMethodDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets title
     *
     * @param string|null $title Payment method details title
     *
     * @return self
     */
    public function setTitle($title)
    {
        if (is_null($title)) {
            ...
            $index = array_search('title', $nullablesSetToNull, true);
            if ($index !== false) {
     ...
     * Sets description
     *
     * @param string|null $description Payment method details description
     *
     * @return self
     */
