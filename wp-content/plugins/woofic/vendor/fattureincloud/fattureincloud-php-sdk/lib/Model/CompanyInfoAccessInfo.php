...
class CompanyInfoAccessInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct($data = null)
    {
        ...
        $this->setIfExists('through_accountant', $data ?? [], null);
    }
    ...
    /**
     * Sets role, the accepted values are available in \FattureInCloud\Model\UserCompanyRole
     *
     ...
     *
     * @param bool|null $through_accountant Company activated through accountant
     *
     * @return self
     */
    public function setThroughAccountant($through_accountant)
    {
        if (is_null($through_accountant)) {
            array_push($this->openAPINullablesSetToNull, 'through_accountant');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('through_accountant', $nullablesSetToNull, true);
            if ($index !== false) {
