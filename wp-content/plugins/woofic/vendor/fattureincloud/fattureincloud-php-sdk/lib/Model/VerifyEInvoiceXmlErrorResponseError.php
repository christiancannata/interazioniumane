...
/**
 * VerifyEInvoiceXmlErrorResponseError Class Doc Comment
 *
 * @category Class
 * @package  FattureInCloud
 * @author   Fatture In Cloud API team
 ...
 */
class VerifyEInvoiceXmlErrorResponseError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerifyEInvoiceXmlErrorResponse_error';
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'validation_result' => '\FattureInCloud\Model\VerifyEInvoiceXmlErrorResponseErrorValidationResult'
    ];
     ...
     *
     * @return \FattureInCloud\Model\VerifyEInvoiceXmlErrorResponseErrorValidationResult|null
     */
     ...
     *
     * @param \FattureInCloud\Model\VerifyEInvoiceXmlErrorResponseErrorValidationResult|null $validation_result validation_result
     *
     * @return self
     */
    public function setValidationResult($validation_result)
    {
        if (is_null($validation_result)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('validation_result', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
