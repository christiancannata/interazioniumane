...
/**
 * ListF24ResponseAggregation Class Doc Comment
 *
 * @category Class
 * @package  FattureInCloud
 * @author   Fatture In Cloud API team
 ...
 */
class ListF24ResponseAggregation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListF24ResponseAggregation';
    ...
    {
        $this->setIfExists('aggregated_data', $data ?? [], null);
    }
    ...
    {
        if (is_null($aggregated_data)) {
            throw new \InvalidArgumentException('non-nullable aggregated_data cannot be null');
        }
