...
/**
 * ReceivedDocumentInfoDefaultValues Class Doc Comment
 *
 * @category Class
 ...
 */
class ReceivedDocumentInfoDefaultValues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceivedDocumentInfo_default_values';
     ...
     * Sets detailed
     *
     * @param bool|null $detailed detailed
     *
     * @return self
     */
    ...
    {
        if (is_null($detailed)) {
            array_push($this->openAPINullablesSetToNull, 'detailed');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('detailed', $nullablesSetToNull, true);
            if ($index !== false) {
