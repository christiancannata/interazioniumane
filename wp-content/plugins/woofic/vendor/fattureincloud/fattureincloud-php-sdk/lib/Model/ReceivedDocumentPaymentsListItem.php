...
/**
 * ReceivedDocumentPaymentsListItem Class Doc Comment
 *
 * @category Class
 * @package  FattureInCloud
 * @author   Fatture In Cloud API team
 ...
 */
class ReceivedDocumentPaymentsListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceivedDocumentPaymentsListItem';
    ...
    protected static $openAPITypes = [
        ...
        'due_date' => '\DateTime',
        'paid_date' => '\DateTime',
        'payment_terms' => '\FattureInCloud\Model\ReceivedDocumentPaymentsListItemPaymentTerms',
        'status' => 'string',
     ...
     * Sets id
     *
     * @param int|null $id Received document payment id
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Received document payment total amount
     *
     * @return self
     */
     ...
     * Sets paid_date
     *
     * @param \DateTime|null $paid_date Received document payment paid date
     *
     * @return self
     */
     ...
     * Gets payment_terms
     *
     * @return \FattureInCloud\Model\ReceivedDocumentPaymentsListItemPaymentTerms|null
     */
     ...
     * Sets payment_terms
     *
     * @param \FattureInCloud\Model\ReceivedDocumentPaymentsListItemPaymentTerms|null $payment_terms payment_terms
     *
     * @return self
     */
    public function setPaymentTerms($payment_terms)
    {
        if (is_null($payment_terms)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payment_terms', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets status
     *
     * @param string|null $status Received document payment status
     *
     * @return self
     */
