...
class FluentForms_Field extends \FluentForm\App\Services\FormBuilder\BaseFieldManager
{
    ...
    public function __construct()
    {
        parent::__construct(
            $this->field_type,
            'Box',
            ['cloud', 'box', 'drive', 'documents', 'files', 'upload', 'video', 'audio', 'media', 'embed'],
    ...
    public function renderResponse($response, $field, $form_id)
    {
        ...
        return apply_filters('letsbox_render_formfield_data', $response, $ashtml, $this);
    }
