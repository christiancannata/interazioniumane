...
class FL_Init
{
    ...
    {
        require_once LETSBOX_ROOTDIR.'/includes/integrations/beaverbuilder/modules/wpcp_letsbox_module/wpcp_letsbox_module.php';
    }
    ...
    {
        $fields[$this->slug] = LETSBOX_ROOTDIR.'/includes/integrations/beaverbuilder/fields/field.php';
