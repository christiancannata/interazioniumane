...
<div id="wpcp" class="wpcp-app">
    ...
    <!-- Modal Selector -->
    <div id="wpcp-modal-acf-selector-box" class="wpcp-dialog hidden">
                        ...
                        <div>
                            ...
                            <div class="mt-3 text-center sm:mt-5">
                                ...
                                <div class="mt-6 mb-4 sm:flex items-center justify-center">
                                    <div id='lb-embedded' class="w-full">
                                        <?php
...
?>
                        ...
                        <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                            ...
                            <button type="button" class="wpcp-button-primary wpcp-acf-dialog-entry-select inline-flex justify-center w-full sm:w-auto"><?php esc_html_e('Add'); ?></button>                            
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Notification -->
    <div id="wpcp-notification" aria-live="assertive" class="fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-end z-[1000000]" style="display:none;">
