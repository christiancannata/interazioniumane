...
class WPCP_LETSBOX_NEWEVENT
{
    ...
    public function __construct()
    {
        ...
        $this->trigger_code = 'WPCP_LETSBOX_NEW_EVENT';
        $this->trigger_meta = 'WPCP_LETSBOX_EVENT_TYPE';
        $this->setup_trigger();
    }
    ...
    protected function setup_trigger()
    {
        ...
        $this->add_action('letsbox_event_added', 20, 4);

        $options = [
            Automator()->helpers->recipe->wpcp_letsbox->options->list_events(null, $this->trigger_meta),
        ];
