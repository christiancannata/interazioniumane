...
/**
 * Class WPCP_LETSBOX_UPLOADSFINISHED.
 */
class WPCP_LETSBOX_UPLOADSFINISHED
{
    use Recipe\Triggers;
    ...
    {
        $this->integration = 'wpcp-letsbox';
        $this->trigger_code = 'WPCP_LETSBOX_UPLOADSFINISHED';
        $this->trigger_meta = 'WPCP_LETSBOX_USERS';
        $this->setup_trigger();
    }
    ...
    protected function setup_trigger()
    {
        ...
        $this->add_action('letsbox_upload_post_process', 20, 2);

        $options = [
            Automator()->helpers->recipe->wpcp_letsbox->options->list_users(null, $this->trigger_meta),
        ];
