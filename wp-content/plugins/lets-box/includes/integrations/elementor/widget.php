...
namespace TheLion\LetsBox\Integrations\Elementor;
...
class Widget extends \Elementor\Widget_Base
{
    public function __construct($data = [], $args = null)
    {
        ...
        wp_register_script('LetsBox.Elementor.Widget', plugins_url('widget.js', __FILE__), ['jquery'], LETSBOX_VERSION);
    }
    ...
    public function get_script_depends()
    {
        ...
        return ['LetsBox.UploadBox', 'LetsBox', 'LetsBox.Elementor.Widget'];
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'event' => 'wpcp:editor:edit_letsbox_shortcode',
            ]
        );
