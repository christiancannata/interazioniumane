(function ($) {
    ...
    function openShortcodeBuilder(view) {
        ...
        var $iframe_template = $("<iframe src='" + LetsBox_vars.ajax_url + "?action=letsbox-getpopup&type=shortcodebuilder&callback=wpcp_lb_elementor_add_content&" + query + "' width='100%' height='500' tabindex='-1' frameborder='0'></iframe>");
