...
class Gutenberg
{
    ...
    {// phpcs:ignore
        wp_register_script(
            'wpcp-letsbox-block-js',
            plugins_url('/dist/blocks.build.js', __FILE__),
            ['wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor'],
            defined('LETSBOX_VERSION') ? LETSBOX_VERSION : filemtime(plugin_dir_path(__DIR__).'dist/blocks.build.js'),
            true
        );

        // Register block editor styles for backend.
        wp_register_style(
            'wpcp-letsbox-block-editor-css',
            plugins_url('dist/blocks.editor.build.css', __FILE__),
            ['wp-edit-blocks'],
            defined('LETSBOX_VERSION') ? LETSBOX_VERSION : filemtime(plugin_dir_path(__DIR__).'dist/blocks.editor.build.css')
        );
        ...
        // WP Localized globals. Use dynamic PHP stuff in JavaScript via `wpcpLetsBoxGlobal` object.
        wp_localize_script(
            'wpcp-letsbox-block-js',
            'wpcpLetsBoxGlobal',
            [
        ...
        register_block_type(
            ...
            [
                ...
                'editor_script' => 'wpcp-letsbox-block-js',
                // Enqueue blocks.editor.build.css in the editor only.
                'editor_style' => 'wpcp-letsbox-block-editor-css',
