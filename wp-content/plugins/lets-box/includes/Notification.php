...
class Notification
{
    ...
    public function send_notification()
    {
        ...
        do_action('letsbox_log_event', 'letsbox_sent_notification', $this->folder, ['notification_type' => $this->type, 'subject' => $subject, 'recipients' => $recipients]);

        do_action('letsbox_notification_sent', $this);
    }
    ...
    private function _process_recipients()
    {
        ...
        $recipients = apply_filters('letsbox_notification_set_recipients', $recipients_template_arr, $this);
    ...
    private function _create_placeholders()
    {
        ...
        $this->placeholders = apply_filters('letsbox_notification_create_placeholders', $this->placeholders, $this);
    }
