...
class Helpers
{
    ...
    public static function check_user_role($roles_to_check = [], $user = null)
    {
        if (!is_array($roles_to_check)) {
            error_log('[WP Cloud Plugin message]: Invalid Roles set. Expected and array or roles, but got: '.var_export($roles_to_check, true));
    ...
    public static function get_default_icon($mimetype, $is_dir = false)
    {
        ...
        return LETSBOX_ICON_SET.'32x32/'.$icon.'.png';
    }
    ...
    public static function encrypt($data)
    {
        ...
        $first_encrypted = openssl_encrypt($data, $method, LETSBOX_AUTH_KEY, OPENSSL_RAW_DATA, $iv);
    ...
    public static function decrypt($input)
    {
        ...
        return openssl_decrypt($first_encrypted, $method, LETSBOX_AUTH_KEY, OPENSSL_RAW_DATA, $iv);
    }
