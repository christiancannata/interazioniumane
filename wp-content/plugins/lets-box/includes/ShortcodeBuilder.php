...
class ShortcodeBuilder
{
    ...
    private function load_nav_tabs()
    {
        ...
        self::$nav_tabs = \apply_filters('letsbox_shortcodebuilder_tabs', $nav_tabs);
    }
    ...
    private function load_fields()
    {
                ...
                'fields' => [
                    'mode' => [
                        ...
                        'options' => [
                            ...
                            'gallery' => ['title' => esc_html__('Gallery', 'wpcloudplugins'), 'imagesrc' => '', 'description' => esc_html__('Amazing gallery for images & videos.', 'wpcloudplugins').'<br/><small>'.sprintf(esc_html__('Supported formats: %s', 'wpcloudplugins'), 'gif, jpg, jpeg, png, bmp, tif, tiff, webp, heic, mp4, m4v, ogg, ogv, webmv').'</small>'],
                            'carousel' => ['title' => esc_html__('Slider / Carousel', 'wpcloudplugins'), 'imagesrc' => '', 'description' => esc_html__('Slick slider for displaying images.', 'wpcloudplugins').'<br/><small>'.sprintf(esc_html__('Supported formats: %s', 'wpcloudplugins'), 'gif, jpg, jpeg, png, bmp, tif, tiff, webp, heic').'</small>'],
        ...
        $fields['private_folders'] = [
            'smartclient_panel' => [
                'title' => esc_html__('Dynamic Folders', 'wpcloudplugins'),
                'description' => esc_html__('Instead of using a static folder location, the module can also point to a dynamic folder location.', 'wpcloudplugins').' <a href="https://www.wpcloudplugins.com/wp-content/plugins/lets-box/_documentation/index.html#module-builder-options-dynamic-folder" target="_blank">('.esc_html__('Documentation', 'wpcloudplugins').')</a>',
                'type' => 'panel',
                'accordion' => false,
                'modules' => ['all'],
                'fields' => [
                    'userfolders' => [
                        ...
                        'options' => [
                            ...
                            'manual' => ['title' => esc_html__('Manual mode'), 'description' => sprintf(esc_html__('I will link the users manually via %sthis page%s.', 'wpcloudplugins'), '<a href="'.admin_url('admin.php?page=LetsBox_settings_linkusers').'" target="_blank">', '</a>'), 'toggle_container' => '#private_folder_manual_panel'],
                    ...
                    'sharerole_panel' => [
                        ...
                        'fields' => [
                            'sharerole' => [
                                ...
                                'type' => 'user_selectbox',
                                'notice_class' => 'warning',
                                'notice' => esc_html__('Box will only create a single shared link per file. Setting a password, expiration date or permission will basically change the sharing permission of the file itself. It will affect the existing shared link for the file.', 'wpcloudplugins'),
                                'modules' => ['all'],
                            ],
                            'share_password' => [
                            ...
                            'share_expire_after' => [
                                ...
                                'type' => 'textbox',
                                'modules' => ['all'],
                                'account_types' => ['personal pro', 'business', 'enterprise'],
                                'notice_class' => 'info',
                            ...
                            'share_allow_download' => [
                                'title' => esc_html__('Allow download', 'wpcloudplugins'),
                                'description' => esc_html__('Should the user be able to download the content via the shared link?', 'wpcloudplugins'),
                                'default' => true,
                                'type' => 'checkbox',
                                'modules' => ['all'],
                            ],
        ...
        $fields['layout'] = [
            ...
            'layout_gallery_view_panel' => [
                ...
                'fields' => [
                    ...
                    'folderthumbs' => [
                        'title' => esc_html__('Show Folder Thumbnails', 'wpcloudplugins'),
                        'description' => esc_html__('Show thumbnails for the folders in the gallery mode.', 'wpcloudplugins'),
                        'default' => false,
                        'type' => 'checkbox',
                        'modules' => ['gallery'],
                        'notice' => esc_html__('When enabled, the loading performance of the Gallery can drop proportional with the number of folders present.', 'wpcloudplugins'),
                        'notice_class' => 'warning',
                    ],
                ],
                'modules' => ['gallery'],
        ...
        // Upload fields
        $max_file_size = min(Helpers::return_bytes(ini_get('post_max_size')), Helpers::return_bytes(ini_get('upload_max_filesize')));
            ...
            'upload_restrictions_panel' => [
                ...
                'fields' => [
                    ...
                    'maxfilesize' => [
                        ...
                        'description' => sprintf(esc_html__('Maximum file size for files that are selected for uploading (e.g. 100 MB). The maximum file size that is supported by your server is: %s.', 'wpcloudplugins'), $post_max_size_str),
                        'type' => 'textbox',
                        'default' => '',
                        'placeholder' => $post_max_size_str,
                        'modules' => ['files', 'upload', 'gallery'],
                    ],
                ],
            ],
        ...
        self::$fields = \apply_filters('letsbox_shortcodebuilder_fields', $fields);
    }
}
