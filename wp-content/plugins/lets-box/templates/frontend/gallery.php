...
\TheLion\LetsBox\Skeleton::get_gallery_placeholders($target_height, 5);
?>
            </div>
        </div>
...
<style>
  ...
  #LetsBox-<?php echo Processor::instance()->get_listtoken(); ?>.wpcp-gallery .image-collage {
    padding: <?php echo Processor::instance()->get_shortcode_option('padding'); ?> !important;
  }
  <?php } ?>

  <?php if (Processor::instance()->get_shortcode_option('border_radius') !== '') {?>
  #LetsBox-<?php echo Processor::instance()->get_listtoken(); ?>.wpcp-gallery .image-container {
    border-radius: <?php echo Processor::instance()->get_shortcode_option('border_radius'); ?>px !important;
  }
  #LetsBox-<?php echo Processor::instance()->get_listtoken(); ?> .entry-top-actions{
