...
<style>
  ...
  #LetsBox-<?php echo Processor::instance()->get_listtoken(); ?> .wpcp-carousel-item {
  ...
  <?php } ?>
    #LetsBox-<?php echo Processor::instance()->get_listtoken(); ?> .wpcp-carousel:not(.wpcp-carousel-loaded) {
      height:<?php echo Processor::instance()->get_shortcode_option('slide_height'); ?>;
    }
    <?php if ('' !== Processor::instance()->get_shortcode_option('border_radius')) {?>
  #LetsBox-<?php echo Processor::instance()->get_listtoken(); ?> .wpcp-carousel-item-holder {
