 ...
 * when updating the plugin. Instead, use the 'letsbox_events_set_summary_template' filter
 ...
 *
 * function change_event_summary_email($template_location, $events){
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:600px;">
                                                            <img alt="" height="auto" src="<?php echo LETSBOX_ROOTPATH; ?>/templates/notifications/images/event_summary_header.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="600">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
        ...
        break;
                                                                    ...
                                                                    <tr style="<?php echo ($current % 2) ? 'background: #f4f4f4;' : ''; ?> height: 35px;">
                                                                        ...
                                                                        <td style="line-height:25px;">
                                                                            <a href="https://letsbox.app.box.com/<?php echo ($entry['entry_is_dir']) ? 'folder' : 'file'; ?>/<?php echo $entry['entry_id']; ?>" target="_blank">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center" style="font-size:0px;padding:10px 25px;padding-top:20px;word-break:break-word;">
                                                                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:16px;text-align:center;color:#000000;">You can change the frequency of this email or turn it on and off by visiting your
                                                                                                    <a href="<?php echo get_admin_url(null, 'admin.php?page=LetsBox_settings#settings_stats'); ?>">Lets-Box options
                                                                                                    </a> page.
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
