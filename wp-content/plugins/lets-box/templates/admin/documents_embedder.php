...
if (!(\TheLion\LetsBox\Helpers::check_user_role($this->settings['permissions_add_embedded']))) {
    exit();
}
  ...
  <form action=" #" data-callback="<?php echo isset($_REQUEST['callback']) ? $_REQUEST['callback'] : ''; ?>">
    ...
    <div class="wrap">
      <div class="letsbox-header">
        ...
        <div class="letsbox-title"><?php echo esc_html__('Embed Files', 'wpcloudplugins'); ?></div>
      </div>
