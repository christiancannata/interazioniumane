...
class Default_Skin extends \TheLion\LetsBox\MediaplayerSkin
{
    ...
    public function load_styles()
    {
        ...
        wp_register_style('LetsBox.Default_Skin.Player.CSS', $this->get_url().'/css/style'.$is_rtl_css.'.css', false, LETSBOX_VERSION);
        wp_enqueue_style('LetsBox.Default_Skin.Player.CSS');
    }
}