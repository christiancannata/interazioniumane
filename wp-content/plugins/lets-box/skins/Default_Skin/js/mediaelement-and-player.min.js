 ...
 */
"use strict";function create_playlistfrom_json(t){var s=[];return null===t||t.length<1||t.forEach(function(t,e){var l={title:t.title,id:t.id,description:t.artist,duration:t.duration,sources:[{src:t.source,type:t.type}],poster:t.poster,thumbnail:t.thumb,size:t.width,folder:t.folder,last_edited_date_str:t.last_edited_date_str,last_edited_time_str:t.last_edited_time_str,purchaselink:t.linktoshop,download:t.download,share:t.share,deeplink:t.deeplink,expires:null},i=[];t.captions&&t.captions.forEach(function(t,e){t={kind:"captions",label:t.label,srclang:t.language,src:t.src};i.push(t)}),l.textTracks=i,s.push(l)}),s}function init_mediaelement(t,e,l,i){var s=t.firstElementChild,a=!0,n=!0;"responsive"!==s.getAttribute("data-aspect-ratio")&&(n=a=!1);l={main:i,rootContainer:t,layout:t.getAttribute("data-layout"),listtoken:e,pluginPath:Default_Skin_vars.player_url+"/js/",playlist:l,stretching:"responsive",enableAutosize:n,setDimensions:a,classPrefix:"wpcp__",toggleCaptionsButtonWhenOnlyOne:!0,jumpForwardInterval:30,timeAndDurationSeparator:"<span> / </span>",skipBackInterval:10,hideVolumeOnTouchDevices:!1===s.querySelector("video, audio").autoplay,audioVolume:"vertical",isFloating:!1,playlistHeight:s.getAttribute("data-max-height"),success:function(t,e){t.options.rootContainer.querySelector(".loading.initialize").style.display="none",t.options.rootContainer.querySelector(".wpcp__main-container").classList.remove("wpcp__loading");var l=new URL(window.location),l=new URLSearchParams(l.search).get("wpcp_link");if(null!==l){l=JSON.parse(decodeURIComponent(window.atob(l)));if(l.source===t.options.main.element.attr("data-source")){const i=t.options.rootContainer.querySelector('.wpcp__playlist-item[data-id="'+l.focus_id+'"]');i.click()}}},error:function(t,e){void 0!==t.options&&(t.options.rootContainer.querySelector(".loading.initialize").style.display="none",t.options.rootContainer.querySelector(".wpcp__main-container").classList.add("error"))}};l.contextMenuItems=[{render:function(t){return void 0===t.enterFullScreen?null:t.isFullScreen?mejs.i18n.t("mejs.fullscreen-off"):mejs.i18n.t("mejs.fullscreen-on")},click:function(t){t.isFullScreen?t.exitFullScreen():t.enterFullScreen()}},{render:function(t){return t.media.muted?mejs.i18n.t("mejs.unmute"):mejs.i18n.t("mejs.mute")},click:function(t){t.media.muted?t.setMuted(!1):t.setMuted(!0)}}];n=s.getAttribute("data-controls").split(",");l.displayPlaylist="1"===s.getAttribute("data-show-playlist"),l.showPlaylistOnload="1"===s.getAttribute("data-open-playlist"),l.playlistInline="1"===s.getAttribute("data-playlist-inline"),l.playlistAutoPlay="1"===s.getAttribute("data-playlist-autoplay");a=s.getAttribute("data-ads-tag-url");""!==a&&(n.push("vast","ads"),l.vastAdTagUrl=a,l.vastAdsType="vast",a=-1<parseInt(s.getAttribute("data-ads-skip")),(l.adsPrerollAdEnableSkip=a)&&(l.adsPrerollAdSkipSeconds=parseInt(s.getAttribute("data-ads-skip")))),l.speeds=["2","1.75","1.5","1.25","1","0.75","0.5","0.25"],l.defaultSpeed="1",n.push("progress","tracks","contextmenu","googleanalytics","custom_playlist"),l.features=n,l.iconSprite="",window.wpcp_playlists[e]=new MediaElementPlayer(t.querySelector("video,audio"),l)}if(void 0===window.wpcp_playlists&&(window.wpcp_playlists={}),function i(s,a,n){function o(l,t){if(!a[l]){if(!s[l]){var e="function"==typeof require&&require;if(!t&&e)return e(l,!0);if(r)return r(l,!0);e=new Error("Cannot find module '"+l+"'");throw e.code="MODULE_NOT_FOUND",e}e=a[l]={exports:{}};s[l][0].call(e.exports,function(t){var e=s[l][1][t];return o(e||t)},e,e.exports,i,s,a,n)}return a[l].exports}for(var r="function"==typeof require&&require,t=0;t<n.length;t++)o(n[t]);return o}({1:[function(t,e,l){mejs.i18n.en["mejs.playlist"]="Toggle Playlist",mejs.i18n.en["mejs.playlist-prev"]="Previous",mejs.i18n.en["mejs.playlist-next"]="Next",mejs.i18n.en["mejs.playlist-loop"]="Loop",mejs.i18n.en["mejs.playlist-shuffle"]="Shuffle",Object.assign(mejs.MepDefaults,{playlist:[],displayPlaylist:!0,showPlaylistOnload:!0,playlistHeight:null,autoClosePlaylist:!1,prevText:null,nextText:null,loopText:null,shuffleText:null,playlistTitle:null,currentMessage:null}),Object.assign(MediaElementPlayer.prototype,{buildcustom_playlist:function(a,t,e,l){var i=mejs.i18n.t("mejs.playlist"),i=mejs.Utils.isString(a.options.playlistTitle)?a.options.playlistTitle:i;a.currentPlaylistItem=0,a.originalControlsIndex=t.style.zIndex,t.style.zIndex=5;t=e.querySelector("."+a.options.classPrefix+"overlay-loading");t&&(t.innerHTML='<div class="loading"><svg class="loader-spinner" viewBox="25 25 50 50"><circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="3" stroke-miterlimit="10"></circle></svg></div>'),a.playlistLayer=document.createElement("div"),a.playlistLayer.className=a.options.classPrefix+"playlist-layer "+a.options.classPrefix+"layer "+(!1===a.options.displayPlaylist||!1===a.options.showPlaylistOnload?a.options.classPrefix+"playlist-hidden":""),a.playlistLayer.innerHTML='<ul class="'+a.options.classPrefix+"playlist "+a.options.classPrefix+'playlist-root" data-folder="/" style="'+(null!==a.options.playlistHeight?"max-height:"+a.options.playlistHeight:"")+'"></ul>',a.options.playlistInline&&mejs.Utils.addClass(a.playlistLayer,a.options.classPrefix+"playlist-inline"),e.insertBefore(a.playlistLayer,e.firstChild),a.createWPCPPlayList_(a.playlistLayer.querySelector("ul")),a.playlistButton=document.createElement("div"),a.playlistButton.className=a.options.classPrefix+"button "+a.options.classPrefix+"playlist-button",a.playlistButton.innerHTML='<button type="button" aria-controls="'+a.id+'" title="'+i+'" aria-label="'+i+'" tabindex="0"></button>',a.playlistButton.addEventListener("click",function(){a.options.playlistInline?jQuery(a.playlistLayer).toggle():jQuery(a.playlistLayer).slideToggle(),a.options.playlistInline&&!1===mejs.Utils.hasClass(a.playlistLayer,a.options.classPrefix+"playlist-hidden")?a.pause():a.options.playlistInline&&a.play()}),!0===a.options.displayPlaylist&&1<a.options.playlist.length&&a.addControlElement(a.playlistButton,"playlist"),a.searchContainer=document.createElement("div"),a.searchContainer.classList.add(a.options.classPrefix+"playlist-search"),a.searchBox=document.createElement("input"),a.searchBox.type="text",a.searchBox.size="40",a.searchBox.tabIndex="0",a.searchBox.placeholder=mejs.i18n.t("mejs.search"),a.searchBox.classList.add(a.options.classPrefix+"search-input"),a.searchContainer.insertBefore(a.searchBox,null),a.searchBox.addEventListener("input",function(t){let l=jQuery(this).val().replace(/(<([^>]+)>)/gi,"");l=new RegExp(l.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&"),"i"),0<jQuery(this).val().length?(clearTimeout(a.searchTimer),a.searchTimer=setTimeout(function(){jQuery("."+a.options.classPrefix+"playlist-item.is-hidden").removeClass("is-hidden"),a.playlist.forEach(function(t,e){-1<t.title.search(l)||-1<t.description.search(l)||-1<t.folder.search(l)||(e=a.playlistLayer.querySelector("."+a.options.classPrefix+'playlist-item[data-playlist-index="'+e+'"]'),jQuery(e).addClass("is-hidden"))}),jQuery("."+a.options.classPrefix+"playlist-item-folder").each(function(){0===jQuery(this).find('li.wpcp__playlist-item:not(".is-hidden")').length&&jQuery(this).addClass("is-hidden")})},100)):(clearTimeout(a.searchTimer),jQuery("."+a.options.classPrefix+"playlist-item.is-hidden").removeClass("is-hidden"))}),!0===a.options.displayPlaylist&&1<a.options.playlist.length&&(a.hasSearch=!0,a.playlistLayer.insertBefore(a.searchContainer,a.playlistLayer.querySelector("ul"))),a.playlistLayer.querySelectorAll("."+a.options.classPrefix+"playlist-item-thumbnail img").forEach(e=>{e.addEventListener("error",t=>{e.src=a.options.main.options.icons_set+"256x256/"+(a.isVideo?"video":"audio")+"-x-generic.png"})}),a.playerDownloadButton=document.createElement("div"),a.playerDownloadButton.className=a.options.classPrefix+"button "+a.options.classPrefix+"download-button",a.playerDownloadButton.innerHTML='<button type="button" aria-controls="'+a.id+'" title="'+mejs.i18n.t("mejs.download-file")+'" aria-label="'+mejs.i18n.t("mejs.download-file")+'" tabindex="0"></button>',a.playerDownloadButton.addEventListener("click",function(){a.playlistLayer.querySelector("."+a.options.classPrefix+'playlist-item[data-playlist-index="'+a.currentPlaylistItem+'"]').querySelector("."+a.options.classPrefix+"playlist-item-download").click()}),!1!==a.options.displayPlaylist&&1!==a.options.playlist.length||(a.addControlElement(a.playerDownloadButton,"playerdownload"),void 0!==a.playerDownloadButton&&(!1===a.playlist[a.currentPlaylistItem].download?a.playerDownloadButton.style.display="none":a.playerDownloadButton.style.display="inline-block")),a.playerShareButton=document.createElement("div"),a.playerShareButton.className=a.options.classPrefix+"button "+a.options.classPrefix+"share-button",a.playerShareButton.innerHTML='<button type="button" aria-controls="'+a.id+'" title="'+mejs.i18n.t("mejs.share")+'" aria-label="'+mejs.i18n.t("mejs.share")+'" tabindex="0"></button>',a.playerShareButton.addEventListener("click",function(t){var e=jQuery(a.playlistLayer.querySelector("."+a.options.classPrefix+'playlist-item[data-playlist-index="'+a.currentPlaylistItem+'"]'));t.stopPropagation(),a.options.main._actionShareEntry(e,t)}),!1!==a.options.displayPlaylist&&1!==a.options.playlist.length||(a.addControlElement(a.playerShareButton,"playershare"),void 0!==a.playerShareButton&&(!1===a.playlist[a.currentPlaylistItem].share?a.playerShareButton.style.display="none":a.playerShareButton.style.display="inline-block")),a.playerDeeplinkButton=document.createElement("div"),a.playerDeeplinkButton.className=a.options.classPrefix+"button "+a.options.classPrefix+"deeplink-button",a.playerDeeplinkButton.innerHTML='<button type="button" aria-controls="'+a.id+'" title="'+mejs.i18n.t("mejs.deeplink")+'" aria-label="'+mejs.i18n.t("mejs.deeplink")+'" tabindex="0"></button>',a.playerDeeplinkButton.addEventListener("click",function(t){var e=jQuery(a.playlistLayer.querySelector("."+a.options.classPrefix+'playlist-item[data-playlist-index="'+a.currentPlaylistItem+'"]'));t.stopPropagation(),a.options.main._actionCreateDeepLink(e,t)}),!1!==a.options.displayPlaylist&&1!==a.options.playlist.length||(a.addControlElement(a.playerDeeplinkButton,"playerdeeplink"),void 0!==a.playerDeeplinkButton&&(!1===a.playlist[a.currentPlaylistItem].deeplink?a.playerDeeplinkButton.style.display="none":a.playerDeeplinkButton.style.display="inline-block")),a.playlistLayer.querySelectorAll("."+a.options.classPrefix+"playlist-item:not(."+a.options.classPrefix+"playlist-item-folder)").forEach(function(t){t.addEventListener("click",function(t){t.stopPropagation();t=parseInt(this.getAttribute("data-playlist-index"));a.loadPlaylistItem(t,!1,!0)})}),a.playlistLayer.querySelectorAll("."+a.options.classPrefix+"playlist-item-folder").forEach(function(i){i.addEventListener("click",function(t){t.stopPropagation();var e=i,l=e.querySelector("ul"),t=e.querySelector("i");mejs.Utils.hasClass(e,a.options.classPrefix+"playlist-item-folder-open")?(mejs.Utils.removeClass(t,"eva-arrow-down"),mejs.Utils.addClass(t,"eva-arrow-right"),mejs.Utils.removeClass(e,a.options.classPrefix+"playlist-item-folder-open"),jQuery(l).slideUp()):(mejs.Utils.addClass(t,"eva-arrow-down"),mejs.Utils.removeClass(t,"eva-arrow-right"),mejs.Utils.addClass(e,a.options.classPrefix+"playlist-item-folder-open"),jQuery(l).slideDown())})}),a.changeLayout(),a.refreshStream=function(){a.pause();var t=a.getCurrentTime();a.setSrc(a.playlist[a.currentPlaylistItem].src),a.setCurrentTime(t),a.play(),a.playlist[a.currentPlaylistItem].expires=null},a.playlistPlayCallback=function(){mejs.Utils.addClass(a.container,a.options.classPrefix+"active"),null!==a.playlist[a.currentPlaylistItem].expires&a.playlist[a.currentPlaylistItem].expires<new Date&&a.refreshStream()},l.addEventListener("play",a.playlistPlayCallback),a.playlistPauseCallback=function(){mejs.Utils.removeClass(a.container,a.options.classPrefix+"active"),a.scrollItemInView();var t=new Date;a.playlist[a.currentPlaylistItem].expires=t.setMinutes(t.getMinutes()+4)},l.addEventListener("pause",a.playlistPauseCallback),a.timeupdateCallback=function(){var t=JSON.stringify({playlist_item:a.currentPlaylistItem,current_time:a.getCurrentTime()});sessionStorage.setItem("wpcp-media-"+a.options.listtoken,t)},l.addEventListener("timeupdate",a.timeupdateCallback),a.playlistEndedCallback=function(){if(!a.options.loop&&!a.adsPlayerHasStarted&&a.options.playlistAutoPlay){let t=a.currentPlaylistItem+1;a.options.shuffleEnabled&&(t=a.shuffleIndex(t)),a.currentPlaylistItem<a.playlist.length-1&&a.loadPlaylistItem(t,!0,!0),mejs.Utils.removeClass(a.container,a.options.classPrefix+"active")}},l.addEventListener("ended",a.playlistEndedCallback),a.container.offsetWidth<380&&a.options.rootContainer.setAttribute("data-layout","list"),window.addEventListener("resize",function(){clearTimeout(a.resizeTimer),a.resizeTimer=setTimeout(function(){a.container.offsetWidth<380?a.options.rootContainer.setAttribute("data-layout","list"):a.options.rootContainer.setAttribute("data-layout",a.options.layout)},100)}),a.playlistCaptionChangeCallback=function(){void 0!==a.selectedTrack&&null!==a.selectedTrack?a.options.startLanguage=a.selectedTrack.srclang:a.options.startLanguage=null},l.addEventListener("captionschange",a.playlistCaptionChangeCallback),a.scrollItemInView=function(){var t,e,l,i=a.playlistLayer.querySelector(".is-selected"),s=i.offsetParent;null!==s&&(e=(t=i.offsetTop)+i.clientHeight,i=(l=s.scrollTop)+s.clientHeight,t<l?jQuery(s).animate({scrollTop:s.scrollTop-l-t}):i<e&&jQuery(s).animate({scrollTop:s.scrollTop+e-i}))},a.lazyLoadingPlaylistItem=function(){var t,e,l,i=a.currentPlaylistItem+1;void 0!==a.playlist[i]&&(null!==typeof a.playlist[i].expires&&a.playlist[i].expires>new Date||(l=new Date,a.playlist[i].expires=l.setMinutes(l.getMinutes()+4),a.playlist[i].preloaded="busy",t=a.playlist[i].src[0],(e=document.createElement("video")).setAttribute("preload","metadata"),e.setAttribute("crossorigin","anonymous"),e.setAttribute("muted",!0),e.setAttribute("playsinline",!0),(l=document.createElement("source")).setAttribute("type",t.type),l.setAttribute("src",t.src),e.appendChild(l),e.onloadedmetadata=function(t){a.playlist[i].preloaded=!0},e.onstalled=function(t){a.playlist[i].preloaded=!0},e.load()))},l.addEventListener("play",a.lazyLoadingPlaylistItem),"VIDEO"===a.node.nodeName&&(a.floating_container=document.querySelector("."+a.options.classPrefix+"floating-container"),a.inner_container=a.container.children[0],null===a.floating_container&&(a.floating_container=document.createElement("div"),a.floating_container.setAttribute("class",a.options.classPrefix+"floating-container"),document.body.appendChild(a.floating_container)),window.addEventListener("scroll",function(){clearTimeout(a.floatingTimer),a.floatingTimer=setTimeout(function(){var t=a.container.parentNode.getBoundingClientRect().top,e=a.container.offsetHeight,t=Math.floor(t+window.scrollY),e=Math.floor(t+e/2);a.options.isFloating=!1===a.paused&&window.scrollY>e,(a.options.isFloating?a.floating_container:a.container.querySelector(".wpcp__mediaelement div")).appendChild(a.node)},50)})),a.keydownCallback=function(t){var e=mejs.Utils.createEvent("click",t.target);return t.target.dispatchEvent(e),!1},a.playlistLayer.addEventListener("keydown",function(t){var e=t.which||t.keyCode||0;~[13,32,38,40].indexOf(e)&&a.keydownCallback(t)});l=sessionStorage.getItem("wpcp-media-"+a.options.listtoken);null!==l&&a.options.rootContainer.getAttribute("data-sort").indexOf("shuffle")<0?(l=JSON.parse(l),a.loadPlaylistItem(l.playlist_item,!0,!1),a.setCurrentTime(l.current_time)):a.loadPlaylistItem(a.currentPlaylistItem,!0,!1),jQuery(a.options.main.element).on({click:function(t){tippy.hideAll();var e=jQuery(a.playlistLayer).find(".entry[data-id='"+jQuery(this).closest("[data-id]").attr("data-id")+"']");t.stopPropagation(),a.options.main._actionShareEntry(e,t)}},"."+a.options.classPrefix+"playlist-item-shortlink"),jQuery(a.options.main.element).on({click:function(t){tippy.hideAll();var e=jQuery(a.playlistLayer).find(".entry[data-id='"+jQuery(this).closest("[data-id]").attr("data-id")+"']");t.stopPropagation(),a.options.main._actionCreateDeepLink(e,t)}},"."+a.options.classPrefix+"playlist-item-deeplink"),a.playlistLayer.querySelectorAll("."+a.options.classPrefix+"playlist-item-file .entry-action-menu-button").forEach(function(t){t.addEventListener("click",function(t){t.stopPropagation()}),tippy(t,{trigger:"click",arrow:!1,offset:0,content:function(t){t=t.querySelector(".tippy-content-holder").cloneNode(!0);return mejs.Utils.removeClass(t,"tippy-content-holder"),t},maxWidth:350,allowHTML:!0,placement:a.options.main.is_rtl?"bottom-end":"bottom-start",appendTo:a.playlistLayer.parentNode,followCursor:"initial",duration:[300,0],interactive:!0,onShow:function(t){t=t.reference.closest(".entry");mejs.Utils.addClass(t,"hasfocus"),mejs.Utils.addClass(t,"popupopen")},onHide:function(t){t=t.reference.closest(".entry");mejs.Utils.removeClass(t,"hasfocus"),mejs.Utils.removeClass(t,"popupopen")}})}),a.playlistLayer.querySelectorAll("."+a.options.classPrefix+"playlist-item-file ."+a.options.classPrefix+"playlist-item-description:not(:empty)").forEach(function(t){tippy(t,{arrow:!1,offset:0,content:function(t){return'<div class="description-textbox"><div class="description-file-name">'+t.parentNode.childNodes[0].childNodes[0].innerHTML+'</div><div class="description-text">'+t.innerHTML+"</div></div>"},maxWidth:350,allowHTML:!0,placement:a.options.main.is_rtl?"bottom-end":"bottom-start",appendTo:a.playlistLayer.parentNode,followCursor:"initial",duration:[300,0],delay:[1e3,null],interactive:!0,onShow:function(t){t=t.reference.closest(".entry");mejs.Utils.addClass(t,"hasfocus"),mejs.Utils.addClass(t,"popupopen")},onHide:function(t){t=t.reference.closest(".entry");mejs.Utils.removeClass(t,"hasfocus"),mejs.Utils.removeClass(t,"popupopen")}})})},cleancustom_playlist:function(t,e,l,i){i.removeEventListener("ended",t.playlistEndedCallback)},buildprevtrack:function(i){var t=mejs.i18n.t("mejs.playlist-prev"),t=mejs.Utils.isString(i.options.prevText)?i.options.prevText:t;i.prevButton=document.createElement("div"),i.prevButton.className=i.options.classPrefix+"button "+i.options.classPrefix+"prev-button",i.prevButton.innerHTML='<button type="button" aria-controls="'+i.id+'" title="'+t+'" aria-label="'+t+'" tabindex="0"></button>',i.prevPlaylistCallback=function(){let t=i.currentPlaylistItem-1;var e,l;i.options.shuffleEnabled&&(t=i.shuffleIndex(t)),i.playlist[t]&&(e=i.playlistLayer.querySelector("."+i.options.classPrefix+'playlist-item[data-playlist-index="'+t+'"]'),l=new Event("click"),e.dispatchEvent(l))},i.prevButton.addEventListener("click",i.prevPlaylistCallback),i.options.playlist.length<2||i.addControlElement(i.prevButton,"prevtrack")},cleanprevtrack:function(t){t.prevButton.removeEventListener("click",t.prevPlaylistCallback)},buildnexttrack:function(i){var t=mejs.i18n.t("mejs.playlist-next"),t=mejs.Utils.isString(i.options.nextText)?i.options.nextText:t;i.nextButton=document.createElement("div"),i.nextButton.className=i.options.classPrefix+"button "+i.options.classPrefix+"next-button",i.nextButton.innerHTML='<button type="button" aria-controls="'+i.id+'" title="'+t+'" aria-label="'+t+'" tabindex="0"></button>',i.nextPlaylistCallback=function(){let t=i.currentPlaylistItem+1;var e,l;i.options.shuffleEnabled&&(t=i.shuffleIndex(t)),i.playlist[t]&&(e=i.playlistLayer.querySelector("."+i.options.classPrefix+'playlist-item[data-playlist-index="'+t+'"]'),l=new Event("click"),e.dispatchEvent(l))},i.nextButton.addEventListener("click",i.nextPlaylistCallback),i.options.playlist.length<2||i.addControlElement(i.nextButton,"nexttrack")},cleannexttrack:function(t){t.nextButton.removeEventListener("click",t.nextPlaylistCallback)},buildloop:function(t){var e=mejs.i18n.t("mejs.playlist-loop"),e=mejs.Utils.isString(t.options.loopText)?t.options.loopText:e;t.loopButton=document.createElement("div"),t.loopButton.className=t.options.classPrefix+"button "+t.options.classPrefix+"loop-button "+(t.options.loop?t.options.classPrefix+"loop-on":t.options.classPrefix+"loop-off"),t.loopButton.innerHTML='<button type="button" aria-controls="'+t.id+'" title="'+e+'" aria-label="'+e+'" tabindex="0"></button>',t.loopCallback=function(){t.options.loop=!t.options.loop,t.options.loop?(mejs.Utils.removeClass(t.loopButton,t.options.classPrefix+"loop-off"),mejs.Utils.addClass(t.loopButton,t.options.classPrefix+"loop-on")):(mejs.Utils.removeClass(t.loopButton,t.options.classPrefix+"loop-on"),mejs.Utils.addClass(t.loopButton,t.options.classPrefix+"loop-off"))},t.loopButton.addEventListener("click",t.loopCallback),t.addControlElement(t.loopButton,"loop")},cleanloop:function(t){t.loopButton.removeEventListener("click",t.loopCallback)},buildshuffle:function(e){var t=mejs.i18n.t("mejs.playlist-shuffle"),t=mejs.Utils.isString(e.options.shuffleText)?e.options.shuffleText:t;e.shuffleButton=document.createElement("div"),e.shuffleButton.className=e.options.classPrefix+"button "+e.options.classPrefix+"shuffle-button "+e.options.classPrefix+"shuffle-off",e.shuffleButton.innerHTML='<button type="button" aria-controls="'+e.id+'" title="'+t+'" aria-label="'+t+'" tabindex="0"></button>',e.shuffleButton.style.display="none",e.media.addEventListener("play",function(){e.shuffleButton.style.display="",e.resetSize()}),e.options.shuffleEnabled=!1,e.options.shufflePlayedItems=[],e.shuffleIndex=function(t){return t=Math.floor(Math.random()*e.playlist.length),-1===e.options.shufflePlayedItems.indexOf(t)?e.options.shufflePlayedItems.push(t):e.options.shufflePlayedItems.length<e.playlist.length?t=e.shuffleIndex(t):e.options.shufflePlayedItems.length>=e.playlist.length&&(e.options.shufflePlayedItems=[],e.options.shufflePlayedItems.push(t)),t},e.shuffleCallback=function(){e.options.shuffleEnabled?(mejs.Utils.removeClass(e.shuffleButton,e.options.classPrefix+"shuffle-on"),mejs.Utils.addClass(e.shuffleButton,e.options.classPrefix+"shuffle-off"),e.options.shuffleEnabled=!1):(mejs.Utils.removeClass(e.shuffleButton,e.options.classPrefix+"shuffle-off"),mejs.Utils.addClass(e.shuffleButton,e.options.classPrefix+"shuffle-on"),e.options.shuffleEnabled=!0)},e.shuffleButton.addEventListener("click",e.shuffleCallback),e.options.playlist.length<2||e.addControlElement(e.shuffleButton,"shuffle")},cleanshuffle:function(t){t.shuffleButton.removeEventListener("click",t.shuffleCallback)},buildzip:function(e){e.zipButton=document.createElement("div"),e.zipButton.className=e.options.classPrefix+"button "+e.options.classPrefix+"zip-button",e.zipButton.innerHTML='<button type="button" aria-controls="'+e.id+'" title="Download All" aria-label="Download All" tabindex="0"></button>',e.zipCallback=function(){var t=jQuery.map(e.playlist,function(t,e){return/id=(.+?)&/.exec(t.sources[0].src)[1]});e.options.main._actionDownloadZip(t)},e.zipButton.addEventListener("click",e.zipCallback),e.addControlElement(e.zipButton,"zip")},createWPCPPlayList_:function(l){var e,i,t,o=this;o.playlist=o.options.playlist.length?o.options.playlist:[],o.playlist.length&&(o.listItems=[],o.playlist.forEach(function(t,e){var s=l,a=1,t=!0===t.folder?[""]:t.folder.split("/"),n="";t.forEach(function(t,e){n+="/"+t.replace(/'/g," ");var l,i=o.playlistLayer.querySelector("ul[data-folder='"+n+"']");null===i&&((i=document.createElement("UL")).classList.add(o.options.classPrefix+"playlist-item-folder-content"),i.style.display="none",i.setAttribute("data-folder",n),""!==t&&((l=document.createElement("LI")).tabIndex=0,l.classList.add(o.options.classPrefix+"playlist-item",o.options.classPrefix+"playlist-item-folder","entry"),l.setAttribute("data-folder",n),l.setAttribute("data-depth",a),l.innerHTML='<div class="'+o.options.classPrefix+'playlist-item-card"><div class="'+o.options.classPrefix+'playlist-item-content"><div class="'+o.options.classPrefix+'playlist-item-title-wrapper"><div class="'+o.options.classPrefix+'playlist-item-title"><span><i class="eva eva-arrow-right"></i> '+t+"</span></div></div></div></div></div>",l.appendChild(i)),s.appendChild(l)),s=i,a+=1})}),o.playlist.forEach(function(t,e){var l=document.createElement("li"),i=(o.id,!0===t.folder?[""]:t.folder.split("/")),s=o.playlistLayer.querySelector("ul[data-folder='/"+t.folder.replace(/'/g," ")+"']"),a=i.length;o.playlist[e].src=t.sources,l.tabIndex=0,l.className=o.options.classPrefix+"playlist-item "+o.options.classPrefix+"playlist-item-file entry"+(0===e?" is-selected":""),""!==i[0]?l.setAttribute("data-depth",a):l.setAttribute("data-depth",0),l.setAttribute("data-playlist-index",e),l.setAttribute("data-id",t.id),l.setAttribute("data-name",t.title),l.innerHTML='<div class="'+o.options.classPrefix+'playlist-item-card">'+(t.thumbnail?'<div class="'+o.options.classPrefix+'playlist-item-thumbnail"><div class="preloading"></div>'+(0<t.duration?'<div class="'+o.options.classPrefix+'playlist-item-duration">'+toHHMMSS(t.duration)+"</div>":"")+'<img tabindex="-1" src="'+t.thumbnail+'" title="'+t.title+'" referrerpolicy="no-referrer" loading="lazy"></div>':"")+'<div class="'+o.options.classPrefix+'playlist-item-content"><div class="'+o.options.classPrefix+'playlist-item-title-wrapper"><div class="'+o.options.classPrefix+'playlist-item-title" title="'+t.title+'">'+t.title+" "+(0<t.textTracks.length?'<i class="eva eva-message-square"></i>':"")+' <i class="eva eva-volume-up-outline"></i></div>'+(!1===t.download&&!1===t.purchaselink&&!1===t.deeplink?"":"<div class='"+o.options.classPrefix+"playlist-item-title-button'><div class='entry-info-button entry-action-menu-button' tabindex='0'><i class='eva eva-more-vertical-outline'></i><div id='menu-"+t.id+"' class='entry-action-menu-button-content tippy-content-holder'><ul data-id='"+t.id+"'>"+(!1!==t.download?'<li><a target="_blank" href="'+t.download+'" class="'+o.options.classPrefix+'playlist-item-download" title="'+mejs.i18n.t("mejs.download-file")+'"><i class="eva eva-download eva-lg"></i>&nbsp;'+mejs.i18n.t("mejs.download-file")+"</a></li>":"")+(!1!==t.purchaselink?'<li><a target="_blank" href="'+t.purchaselink+'" class="'+o.options.classPrefix+'playlist-item-purchase" title="'+mejs.i18n.t("mejs.purchase")+'"><i class="eva eva-shopping-cart eva-lg"></i>&nbsp;'+mejs.i18n.t("mejs.purchase")+"</a></li>":"")+(!1!==t.deeplink?'<li><a class="'+o.options.classPrefix+'playlist-item-deeplink" title="'+mejs.i18n.t("mejs.deeplink")+'"><i class="eva eva-link eva-lg"></i>&nbsp;'+mejs.i18n.t("mejs.deeplink")+"</a></li>":"")+(!1!==t.share?'<li><a class="'+o.options.classPrefix+'playlist-item-shortlink" title="'+mejs.i18n.t("mejs.share")+'"><i class="eva eva-share-outline eva-lg"></i>&nbsp;'+mejs.i18n.t("mejs.share")+"</a></li>":"")+"</ul></div></div></div>")+'</div><div class="'+o.options.classPrefix+'playlist-item-metadata"><div class="'+o.options.classPrefix+'playlist-item-lastedited"><div><span class="'+o.options.classPrefix+'playlist-item-lastedited-date">'+t.last_edited_date_str+'</span> <span class="'+o.options.classPrefix+'playlist-item-lastedited-time">'+t.last_edited_time_str+'</span></div></div></div><div class="'+o.options.classPrefix+'playlist-item-description">'+t.description+"</div></div></div>",o.listItems.push(l.outerHTML),s.appendChild(l)}),e=0,i=[],o.playlistLayer.querySelectorAll("."+o.options.classPrefix+"playlist-item-file").forEach(function(t){i[e]=o.playlist[t.getAttribute("data-playlist-index")],t.setAttribute("data-playlist-index",e),e++}),o.playlist=i,o.playlistLayer.querySelectorAll("ul").forEach(function(e){let l=0;for(let t=0;t<e.children.length;t++)e.children[t].classList.contains(o.options.classPrefix+"playlist-item-folder")&&l++;e.style.gridTemplateRows="repeat("+l+", auto)"}),null===(t=o.playlistLayer.querySelector("li[data-depth='0']"))&&(t=o.playlistLayer.querySelector("."+o.options.classPrefix+"playlist-item[data-playlist-index='0']")),t=parseInt(t.getAttribute("data-playlist-index")),o.currentPlaylistItem=t)},loadPlaylistItem:function(t,e,l){var i=this,s=i.playlistLayer.querySelector(".is-selected"),a=i.playlistLayer.querySelector("."+i.options.classPrefix+"playlist-item[data-playlist-index='"+t+"']");i.isVideo&&!0===i.options.autoClosePlaylist&&jQuery(i.playlistLayer).slideToggle(),mejs.Utils.removeClass(s,"is-selected"),mejs.Utils.addClass(a,"is-selected"),i.openPlaylistSubFolders(a),i.currentPlaylistItem===t&&!0!==e||(i.currentPlaylistItem=t,i.options.googleAnalyticsTitle=i.playlist[t].title+(null!==i.playlist[t].description?" | "+i.playlist[t].description:""),i.setSrc(i.playlist[t].src),i.setPoster(i.playlist[t].poster),i.scrollItemInView(),i.adsCurrentMediaUrl=i.playlist[t].src,void 0!==i.adsDataIsLoading&&!0===i.adsDataIsLoading||(void 0!==i.playerDownloadButton&&(!1===i.playlist[i.currentPlaylistItem].download?i.playerDownloadButton.style.display="none":i.playerDownloadButton.style.display="inline-block"),void 0!==i.playerShareButton&&(!1===i.playlist[i.currentPlaylistItem].share?i.playerShareButton.style.display="none":i.playerShareButton.style.display="inline-block"),void 0!==i.playerDeeplinkButton&&(!1===i.playlist[i.currentPlaylistItem].deeplink?i.playerDeeplinkButton.style.display="none":i.playerDeeplinkButton.style.display="inline-block"),i.load(),(i.node.getAutoplay()||l)&&i.play().then(()=>{}).catch(t=>{!1===navigator.userActivation.hasBeenActive&&i.setMuted(!0),i.play().then(()=>{}).catch(t=>{i.setMuted(!1)})}),i.options.features.forEach(function(t){"speed"!==t||void 0!==i.speedButton?"ads"===t&&i.adsPlayerHasStarted&&(i.adsLoaded=!1,i.options.indexPreroll=0,i.options.adsPlayerHasStarted=!1,i.adsDataIsLoading=!1,i.buildads(i,i.getElement(i.controls),i.getElement(i.layers))):i.buildspeed(i,i.getElement(i.controls),i.getElement(i.layers),i.media)})),i.loadPlaylistTracks(i.currentPlaylistItem))},loadPlaylistTracks:function(t){var i=this,t=i.playlist[t].textTracks;i.trackFiles=[],0<t.length&&t.forEach(function(t,e){var l=document.createElement("track");l.kind=t.kind,l.label=t.label,l.src=t.src,l.srclang=t.srclang,i.trackFiles.push(l)}),setTimeout(function(){i.rebuildtracks(),i.changeLayout(),i.findTracks(),i.loadTrack(0),i.tracks.forEach(function(t,e){if(""===i.options.startLanguage||null===i.options.startLanguage||t.srclang===i.options.startLanguage)return i.setTrack(t.trackId)})},1e3)},openPlaylistSubFolders:function(t){for(var e=t.parentNode;e&&!e.classList.contains(this.options.classPrefix+"playlist-root");)if(!1!==e.classList.contains(this.options.classPrefix+"playlist-item-folder")){if(e.classList.contains(this.options.classPrefix+"playlist-item-folder-open"))break;e.click(),e=e.parentNode}else e=e.parentNode},changeLayout:function(){var t,e=this;void 0===e.leftcontrols&&(t=document.createElement("div"),l=document.createElement("div"),mejs.Utils.addClass(t,e.options.classPrefix+"controls-left"),mejs.Utils.addClass(l,e.options.classPrefix+"controls-right"),e.controls.appendChild(t),e.controls.appendChild(l),e.leftcontrols=t,e.rightcontrols=l);var l=e.controls.querySelectorAll(".wpcp__prev-button, .wpcp__playpause-button, .wpcp__next-button, .wpcp__volume-button, .wpcp__horizontal-volume-slider, .wpcp__currenttime-container, .wpcp__time, wpcp__duration-container");e.isVideo||(l=e.controls.querySelectorAll(".wpcp__prev-button, .wpcp__playpause-button, .wpcp__next-button, .wpcp__currenttime-container, .wpcp__time, wpcp__duration-container")),l.forEach(function(t){e.leftcontrols.appendChild(t)});l=e.controls.querySelectorAll(".wpcp__skip-back-button, .wpcp__jump-forward-button, .wpcp__speed-button, .wpcp__shuffle-button, .wpcp__loop-button, .wpcp__deeplink-button, .wpcp__share-button, .wpcp__download-button, .wpcp__fullscreen-button, .wpcp__zip-button, .wpcp__playlist-button, .wpcp__captions-button, .wpcp__chromecast-button, .wpcp__airplay-button");e.isVideo||(l=e.controls.querySelectorAll(".wpcp__skip-back-button, .wpcp__jump-forward-button, .wpcp__speed-button, .wpcp__shuffle-button, .wpcp__loop-button, .wpcp__deeplink-button, .wpcp__share-button, .wpcp__download-button, .wpcp__volume-button, .wpcp__horizontal-volume-slider, .wpcp__fullscreen-button, .wpcp__zip-button, .wpcp__playlist-button, .wpcp__captions-button, .wpcp__chromecast-button, .wpcp__airplay-button")),l.forEach(function(t){e.rightcontrols.appendChild(t)}),e.playlistLayer.parentNode!==e.container.parentNode&&e.container.parentNode.appendChild(e.playlistLayer)}})},{}]},{},[1]),!navigator.userActivation){navigator.userActivation={hasBeenActive:!1};let e=t=>{t.isTrusted&&(navigator.userActivation.hasBeenActive=!0,window.removeEventListener("click",e))};window.addEventListener("click",e)}