...
$ads_tag_url = LETSBOX_ADMIN_URL.'?action=letsbox-getads&account_id='.App::get_current_account()->get_id().'&listtoken='.Processor::instance()->get_listtoken();
...
<style>
  #LetsBox-<?php echo Processor::instance()->get_listtoken(); ?> .wpcp__container.wpcp__video,
  #LetsBox-<?php echo Processor::instance()->get_listtoken(); ?> .wpcp__main-container video,
  #LetsBox-<?php echo Processor::instance()->get_listtoken(); ?> .wpcp__main-container.wpcp__loading.wpcp__video,
  #LetsBox-<?php echo Processor::instance()->get_listtoken(); ?> .wpcp__playlist-item-thumbnail>img {
