...
$max_height = $this->get_processor()->get_shortcode_option('maxheight');
...
$ads_tag_url = LETSBOX_ADMIN_URL.'?action=letsbox-getads&listtoken='.$this->get_processor()->get_listtoken();
...
?><div 
  ...
  data-max-height="<?php echo empty($max_height) ? 'none': $max_height; ?>"
  >
