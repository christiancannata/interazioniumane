 ...
 */
"use strict";function create_playlistfrom_json(t){var i=[];return null===t||t.length<1||t.forEach(function(t,e){var l={title:t.title,description:t.artist,duration:t.duration,sources:[{src:t.source,type:t.type}],poster:t.poster,thumbnail:t.thumb,size:t.width,folder:t.folder,last_edited_date_str:t.last_edited_date_str,last_edited_time_str:t.last_edited_time_str,purchaselink:t.linktoshop,download:t.download,expires:null},s=[];t.captions&&t.captions.forEach(function(t,e){t={kind:"captions",label:t.label,srclang:t.language,src:t.src};s.push(t)}),l.textTracks=s,i.push(l)}),i}function init_mediaelement(t,e,l){var s=t.firstElementChild,i=!0,a=!0;"responsive"!==s.getAttribute("data-aspect-ratio")&&(a=i=!1);l={rootContainer:t,listtoken:e,pluginPath:Default_Skin_vars.player_url+"/js/",playlist:l,stretching:"responsive",enableAutosize:a,setDimensions:i,classPrefix:"wpcp__",toggleCaptionsButtonWhenOnlyOne:!0,jumpForwardInterval:30,timeAndDurationSeparator:"<span> / </span>",skipBackInterval:10,hideVolumeOnTouchDevices:!1===s.querySelector("video, audio").autoplay,audioVolume:"vertical",isFloating:!1,playlistHeight:s.getAttribute("data-max-height"),success:function(t,e){t.options.rootContainer.querySelector(".loading.initialize").style.display="none",t.options.rootContainer.querySelector(".wpcp__main-container").classList.remove("wpcp__loading")},error:function(t,e){void 0!==t.options&&(t.options.rootContainer.querySelector(".loading.initialize").style.display="none",t.options.rootContainer.querySelector(".wpcp__main-container").classList.add("error"))}};l.contextMenuItems=[{render:function(t){return void 0===t.enterFullScreen?null:t.isFullScreen?mejs.i18n.t("mejs.fullscreen-off"):mejs.i18n.t("mejs.fullscreen-on")},click:function(t){t.isFullScreen?t.exitFullScreen():t.enterFullScreen()}},{render:function(t){return t.media.muted?mejs.i18n.t("mejs.unmute"):mejs.i18n.t("mejs.mute")},click:function(t){t.media.muted?t.setMuted(!1):t.setMuted(!0)}}];a=s.getAttribute("data-controls").split(",");l.displayPlaylist="1"===s.getAttribute("data-show-playlist"),l.showPlaylistOnload="1"===s.getAttribute("data-open-playlist"),l.playlistInline="1"===s.getAttribute("data-playlist-inline"),l.playlistAutoPlay="1"===s.getAttribute("data-playlist-autoplay");i=s.getAttribute("data-ads-tag-url");""!==i&&(a.push("vast","ads"),l.vastAdTagUrl=i,l.vastAdsType="vast",i=-1<parseInt(s.getAttribute("data-ads-skip")),(l.adsPrerollAdEnableSkip=i)&&(l.adsPrerollAdSkipSeconds=parseInt(s.getAttribute("data-ads-skip")))),l.speeds=["2","1.75","1.5","1.25","1","0.75","0.5","0.25"],l.defaultSpeed="1",a.push("progress","tracks","contextmenu","googleanalytics","custom_playlist"),l.features=a,l.iconSprite="",window.wpcp_playlists[e]=new MediaElementPlayer(t.querySelector("video,audio"),l)}if(void 0===window.wpcp_playlists&&(window.wpcp_playlists={}),function s(i,a,n){function o(l,t){if(!a[l]){if(!i[l]){var e="function"==typeof require&&require;if(!t&&e)return e(l,!0);if(r)return r(l,!0);e=new Error("Cannot find module '"+l+"'");throw e.code="MODULE_NOT_FOUND",e}e=a[l]={exports:{}};i[l][0].call(e.exports,function(t){var e=i[l][1][t];return o(e||t)},e,e.exports,s,i,a,n)}return a[l].exports}for(var r="function"==typeof require&&require,t=0;t<n.length;t++)o(n[t]);return o}({1:[function(t,e,l){mejs.i18n.en["mejs.playlist"]="Toggle Playlist",mejs.i18n.en["mejs.playlist-prev"]="Previous",mejs.i18n.en["mejs.playlist-next"]="Next",mejs.i18n.en["mejs.playlist-loop"]="Loop",mejs.i18n.en["mejs.playlist-shuffle"]="Shuffle",Object.assign(mejs.MepDefaults,{playlist:[],displayPlaylist:!0,showPlaylistOnload:!0,playlistHeight:null,autoClosePlaylist:!1,prevText:null,nextText:null,loopText:null,shuffleText:null,playlistTitle:null,currentMessage:null}),Object.assign(MediaElementPlayer.prototype,{buildcustom_playlist:function(a,t,e,l){var s=mejs.i18n.t("mejs.playlist"),s=mejs.Utils.isString(a.options.playlistTitle)?a.options.playlistTitle:s;a.currentPlaylistItem=0,a.originalControlsIndex=t.style.zIndex,t.style.zIndex=5;t=e.querySelector("."+a.options.classPrefix+"overlay-loading");t&&(t.innerHTML='<div class="loading"><svg class="loader-spinner" viewBox="25 25 50 50"><circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="3" stroke-miterlimit="10"></circle></svg></div>'),a.playlistLayer=document.createElement("div"),a.playlistLayer.className=a.options.classPrefix+"playlist-layer  "+a.options.classPrefix+"layer "+(!1===a.options.displayPlaylist||!1===a.options.showPlaylistOnload?a.options.classPrefix+"playlist-hidden":"")+" "+a.options.classPrefix+"playlist-selector",a.playlistLayer.innerHTML='<ul class="'+a.options.classPrefix+'playlist-selector-list" data-folder="/" style="max-height:'+(null===a.options.playlistHeight||a.options.playlistInline?"calc(100%)":a.options.playlistHeight)+'"></ul>',a.options.playlistInline&&mejs.Utils.addClass(a.playlistLayer,a.options.classPrefix+"playlist-inline"),e.insertBefore(a.playlistLayer,e.firstChild),a.createWPCPPlayList_(a.playlistLayer.querySelector("ul")),a.playlistButton=document.createElement("div"),a.playlistButton.className=a.options.classPrefix+"button "+a.options.classPrefix+"playlist-button",a.playlistButton.innerHTML='<button type="button" aria-controls="'+a.id+'" title="'+s+'" aria-label="'+s+'" tabindex="0"></button>',a.playlistButton.addEventListener("click",function(){mejs.Utils.toggleClass(a.playlistLayer,a.options.classPrefix+"playlist-hidden"),a.options.playlistInline&&!1===mejs.Utils.hasClass(a.playlistLayer,a.options.classPrefix+"playlist-hidden")?a.pause():a.options.playlistInline&&a.play()}),!0===a.options.displayPlaylist&&1<a.options.playlist.length&&a.addControlElement(a.playlistButton,"playlist"),a.playerDownloadButton=document.createElement("div"),a.playerDownloadButton.className=a.options.classPrefix+"button "+a.options.classPrefix+"download-button",a.playerDownloadButton.innerHTML='<button type="button" aria-controls="'+a.id+'" title="'+mejs.i18n.t("mejs.download-file")+'" aria-label="'+mejs.i18n.t("mejs.download-file")+'" tabindex="0"></button>',a.playerDownloadButton.addEventListener("click",function(){a.playlistLayer.querySelector("."+a.options.classPrefix+'playlist-selector-list-item[data-playlist-index="'+a.currentPlaylistItem+'"]').querySelector("."+a.options.classPrefix+"playlist-item-download").click()}),!1!==a.options.displayPlaylist&&1!==a.options.playlist.length||(a.addControlElement(a.playerDownloadButton,"playerdownload"),void 0!==a.playerDownloadButton&&(!1===a.playlist[a.currentPlaylistItem].download?a.playerDownloadButton.style.display="none":a.playerDownloadButton.style.display="inline-block")),a.playlistLayer.querySelectorAll("."+a.options.classPrefix+"playlist-selector-list-item:not(."+a.options.classPrefix+"playlist-selector-list-item-folder-header)").forEach(function(t){t.addEventListener("click",function(){var t=parseInt(this.getAttribute("data-playlist-index"));a.loadPlaylistItem(t,!1,!0)})}),a.playlistLayer.querySelectorAll("."+a.options.classPrefix+"playlist-selector-list-item-folder-header").forEach(function(s){s.addEventListener("click",function(t){for(var e=t.target;e.parentNode&&e!==s;)e=e.parentNode;var l=e.nextSibling,t=e.querySelector("i");mejs.Utils.hasClass(l,a.options.classPrefix+"playlist-selector-list-item-folder-hidden")?(mejs.Utils.addClass(t,"eva-arrow-down"),mejs.Utils.removeClass(t,"eva-arrow-right"),mejs.Utils.removeClass(l,a.options.classPrefix+"playlist-selector-list-item-folder-hidden")):(mejs.Utils.removeClass(t,"eva-arrow-down"),mejs.Utils.addClass(t,"eva-arrow-right"),mejs.Utils.addClass(l,a.options.classPrefix+"playlist-selector-list-item-folder-hidden"))})}),a.changeLayout(),a.refreshStream=function(){a.pause();var t=a.getCurrentTime();a.setSrc(a.playlist[a.currentPlaylistItem].src),a.setCurrentTime(t),a.play(),a.playlist[a.currentPlaylistItem].expires=null},a.playlistPlayCallback=function(){mejs.Utils.addClass(a.container,a.options.classPrefix+"active"),null!==a.playlist[a.currentPlaylistItem].expires&a.playlist[a.currentPlaylistItem].expires<new Date&&a.refreshStream()},l.addEventListener("play",a.playlistPlayCallback),a.playlistPauseCallback=function(){mejs.Utils.removeClass(a.container,a.options.classPrefix+"active"),a.scrollItemInView();var t=new Date;a.playlist[a.currentPlaylistItem].expires=t.setMinutes(t.getMinutes()+4)},l.addEventListener("pause",a.playlistPauseCallback),a.timeupdateCallback=function(){var t=JSON.stringify({playlist_item:a.currentPlaylistItem,current_time:a.getCurrentTime()});sessionStorage.setItem("wpcp-media-"+a.options.listtoken,t)},l.addEventListener("timeupdate",a.timeupdateCallback),a.playlistEndedCallback=function(){if(!a.options.loop&&!a.adsPlayerHasStarted&&a.options.playlistAutoPlay){let t=a.currentPlaylistItem+1;a.options.shuffleEnabled&&(t=a.shuffleIndex(t)),a.currentPlaylistItem<a.playlist.length-1&&a.loadPlaylistItem(t,!0,!0),mejs.Utils.removeClass(a.container,a.options.classPrefix+"active")}},l.addEventListener("ended",a.playlistEndedCallback),a.playlistResizeCallback=function(){},l.addEventListener("playing",a.playlistResizeCallback),l.addEventListener("resize",a.playlistResizeCallback),a.playlistCaptionChangeCallback=function(){void 0!==a.selectedTrack&&null!==a.selectedTrack?a.options.startLanguage=a.selectedTrack.srclang:a.options.startLanguage=null},l.addEventListener("captionschange",a.playlistCaptionChangeCallback),a.scrollItemInView=function(){var t,e,l,s=a.playlistLayer.querySelector("."+a.options.classPrefix+"playlist-selected"),i=s.offsetParent;null!==i&&(e=(t=s.offsetTop)+s.clientHeight,s=(l=i.scrollTop)+i.clientHeight,t<l?jQuery(i).animate({scrollTop:i.scrollTop-l-t}):s<e&&jQuery(i).animate({scrollTop:i.scrollTop+e-s}))},a.lazyLoadingPlaylistItem=function(){var t,e,l,s=a.currentPlaylistItem+1;void 0!==a.playlist[s]&&(null!==typeof a.playlist[s].expires&&a.playlist[s].expires>new Date||(l=new Date,a.playlist[s].expires=l.setMinutes(l.getMinutes()+4),a.playlist[s].preloaded="busy",t=a.playlist[s].src[0],(e=document.createElement("video")).setAttribute("preload","metadata"),e.setAttribute("crossorigin","anonymous"),e.setAttribute("muted",!0),e.setAttribute("playsinline",!0),(l=document.createElement("source")).setAttribute("type",t.type),l.setAttribute("src",t.src),e.appendChild(l),e.onloadedmetadata=function(t){a.playlist[s].preloaded=!0},e.onstalled=function(t){a.playlist[s].preloaded=!0},e.load()))},l.addEventListener("play",a.lazyLoadingPlaylistItem),"VIDEO"===a.node.nodeName&&(a.floating_container=document.querySelector("."+a.options.classPrefix+"floating-container"),a.inner_container=a.container.children[0],null===a.floating_container&&(a.floating_container=document.createElement("div"),a.floating_container.setAttribute("class",a.options.classPrefix+"floating-container"),document.body.appendChild(a.floating_container)),window.addEventListener("scroll",function(){clearTimeout(a.floatingTimer),a.floatingTimer=setTimeout(function(){var t=a.container.parentNode.getBoundingClientRect().top,e=a.container.offsetHeight,t=Math.floor(t+window.scrollY),e=Math.floor(t+e/2);a.options.isFloating=!1===a.paused&&window.scrollY>e,(a.options.isFloating?a.floating_container:a.container.querySelector(".wpcp__mediaelement div")).appendChild(a.node)},50)})),a.keydownCallback=function(t){var e=mejs.Utils.createEvent("click",t.target);return t.target.dispatchEvent(e),!1},a.playlistLayer.addEventListener("keydown",function(t){var e=t.which||t.keyCode||0;~[13,32,38,40].indexOf(e)&&a.keydownCallback(t)});l=sessionStorage.getItem("wpcp-media-"+a.options.listtoken);null!==l&&a.options.rootContainer.getAttribute("data-sort").indexOf("shuffle")<0?(l=JSON.parse(l),a.loadPlaylistItem(l.playlist_item,!0,!1),a.setCurrentTime(l.current_time)):a.loadPlaylistItem(a.currentPlaylistItem,!0,!1)},cleancustom_playlist:function(t,e,l,s){s.removeEventListener("ended",t.playlistEndedCallback)},buildprevtrack:function(s){var t=mejs.i18n.t("mejs.playlist-prev"),t=mejs.Utils.isString(s.options.prevText)?s.options.prevText:t;s.prevButton=document.createElement("div"),s.prevButton.className=s.options.classPrefix+"button "+s.options.classPrefix+"prev-button",s.prevButton.innerHTML='<button type="button" aria-controls="'+s.id+'" title="'+t+'" aria-label="'+t+'" tabindex="0"></button>',s.prevPlaylistCallback=function(){let t=s.currentPlaylistItem-1;var e,l;s.options.shuffleEnabled&&(t=s.shuffleIndex(t)),s.playlist[t]&&(e=s.playlistLayer.querySelector("."+s.options.classPrefix+'playlist-item[data-playlist-index="'+t+'"]'),l=new Event("click"),e.dispatchEvent(l))},s.prevButton.addEventListener("click",s.prevPlaylistCallback),s.options.playlist.length<2||s.addControlElement(s.prevButton,"prevtrack")},cleanprevtrack:function(t){t.prevButton.removeEventListener("click",t.prevPlaylistCallback)},buildnexttrack:function(s){var t=mejs.i18n.t("mejs.playlist-next"),t=mejs.Utils.isString(s.options.nextText)?s.options.nextText:t;s.nextButton=document.createElement("div"),s.nextButton.className=s.options.classPrefix+"button "+s.options.classPrefix+"next-button",s.nextButton.innerHTML='<button type="button" aria-controls="'+s.id+'" title="'+t+'" aria-label="'+t+'" tabindex="0"></button>',s.nextPlaylistCallback=function(){let t=s.currentPlaylistItem+1;var e,l;s.options.shuffleEnabled&&(t=s.shuffleIndex(t)),s.playlist[t]&&(e=s.playlistLayer.querySelector("."+s.options.classPrefix+'playlist-item[data-playlist-index="'+t+'"]'),l=new Event("click"),e.dispatchEvent(l))},s.nextButton.addEventListener("click",s.nextPlaylistCallback),s.options.playlist.length<2||s.addControlElement(s.nextButton,"nexttrack")},cleannexttrack:function(t){t.nextButton.removeEventListener("click",t.nextPlaylistCallback)},buildloop:function(t){var e=mejs.i18n.t("mejs.playlist-loop"),e=mejs.Utils.isString(t.options.loopText)?t.options.loopText:e;t.loopButton=document.createElement("div"),t.loopButton.className=t.options.classPrefix+"button "+t.options.classPrefix+"loop-button "+(t.options.loop?t.options.classPrefix+"loop-on":t.options.classPrefix+"loop-off"),t.loopButton.innerHTML='<button type="button" aria-controls="'+t.id+'" title="'+e+'" aria-label="'+e+'" tabindex="0"></button>',t.loopCallback=function(){t.options.loop=!t.options.loop,t.options.loop?(mejs.Utils.removeClass(t.loopButton,t.options.classPrefix+"loop-off"),mejs.Utils.addClass(t.loopButton,t.options.classPrefix+"loop-on")):(mejs.Utils.removeClass(t.loopButton,t.options.classPrefix+"loop-on"),mejs.Utils.addClass(t.loopButton,t.options.classPrefix+"loop-off"))},t.loopButton.addEventListener("click",t.loopCallback),t.addControlElement(t.loopButton,"loop")},cleanloop:function(t){t.loopButton.removeEventListener("click",t.loopCallback)},buildshuffle:function(e){var t=mejs.i18n.t("mejs.playlist-shuffle"),t=mejs.Utils.isString(e.options.shuffleText)?e.options.shuffleText:t;e.shuffleButton=document.createElement("div"),e.shuffleButton.className=e.options.classPrefix+"button "+e.options.classPrefix+"shuffle-button "+e.options.classPrefix+"shuffle-off",e.shuffleButton.innerHTML='<button type="button" aria-controls="'+e.id+'" title="'+t+'" aria-label="'+t+'" tabindex="0"></button>',e.shuffleButton.style.display="none",e.media.addEventListener("play",function(){e.shuffleButton.style.display="",e.resetSize()}),e.options.shuffleEnabled=!1,e.options.shufflePlayedItems=[],e.shuffleIndex=function(t){return t=Math.floor(Math.random()*e.playlist.length),-1===e.options.shufflePlayedItems.indexOf(t)?e.options.shufflePlayedItems.push(t):e.options.shufflePlayedItems.length<e.playlist.length?t=e.shuffleIndex(t):e.options.shufflePlayedItems.length>=e.playlist.length&&(e.options.shufflePlayedItems=[],e.options.shufflePlayedItems.push(t)),t},e.shuffleCallback=function(){e.options.shuffleEnabled?(mejs.Utils.removeClass(e.shuffleButton,e.options.classPrefix+"shuffle-on"),mejs.Utils.addClass(e.shuffleButton,e.options.classPrefix+"shuffle-off"),e.options.shuffleEnabled=!1):(mejs.Utils.removeClass(e.shuffleButton,e.options.classPrefix+"shuffle-off"),mejs.Utils.addClass(e.shuffleButton,e.options.classPrefix+"shuffle-on"),e.options.shuffleEnabled=!0)},e.shuffleButton.addEventListener("click",e.shuffleCallback),e.options.playlist.length<2||e.addControlElement(e.shuffleButton,"shuffle")},cleanshuffle:function(t){t.shuffleButton.removeEventListener("click",t.shuffleCallback)},buildzip:function(l){l.zipButton=document.createElement("div"),l.zipButton.className=l.options.classPrefix+"button "+l.options.classPrefix+"zip-button",l.zipButton.innerHTML='<button type="button" aria-controls="'+l.id+'" title="Download All" aria-label="Download All" tabindex="0"></button>',l.zipCallback=function(){var t=jQuery(this).closest(".media").data("cp-LetsBox"),e=jQuery.map(l.playlist,function(t,e){return/id=(.+?)&/.exec(t.sources[0].src)[1]});t._actionDownloadZip(e)},l.zipButton.addEventListener("click",l.zipCallback),l.addControlElement(l.zipButton,"zip")},createWPCPPlayList_:function(l){var e,s,t,o=this;o.playlist=o.options.playlist.length?o.options.playlist:[],o.playlist.length&&(o.listItems=[],o.playlist.forEach(function(t,e){var i=l,a=1,t=!0===t.folder?[""]:t.folder.split("/"),n="";t.forEach(function(t,e){n+="/"+t.replace(/'/g," ");var l,s=o.playlistLayer.querySelector("ul[data-folder='"+n+"']");null===s&&((s=document.createElement("UL")).classList.add(o.options.classPrefix+"playlist-selector-list-item-folder",o.options.classPrefix+"playlist-selector-list-item-folder-hidden"),s.setAttribute("data-folder",n),""!==t&&((l=document.createElement("LI")).classList.add(o.options.classPrefix+"playlist-selector-list-item",o.options.classPrefix+"playlist-selector-list-item-folder-header"),l.setAttribute("data-folder",n),l.setAttribute("data-depth",a),l.style.paddingLeft=16*(a-1)-8+"px",l.innerHTML='<div class="'+o.options.classPrefix+'playlist-item-content"><div class="'+o.options.classPrefix+'playlist-item-title"><span><i class="eva eva-arrow-right"></i> '+t+"</span></div></div></div>",i.appendChild(l)),i.appendChild(s)),i=s,a+=1})}),o.playlist.forEach(function(t,e){var l=document.createElement("li"),s=(o.id,!0===t.folder?[""]:t.folder.split("/")),i=o.playlistLayer.querySelector("ul[data-folder='/"+t.folder.replace(/'/g," ")+"']"),a=s.length;o.playlist[e].src=t.sources,l.tabIndex=0,l.className=o.options.classPrefix+"playlist-selector-list-item"+(0===e?" "+o.options.classPrefix+"playlist-selected":""),""!==s[0]?(l.style.paddingLeft=16*a+"px",l.setAttribute("data-depth",a)):l.setAttribute("data-depth",0),l.setAttribute("data-playlist-index",e),l.innerHTML='<div class="'+o.options.classPrefix+'playlist-item-inner">'+(t.thumbnail?'<div class="'+o.options.classPrefix+'playlist-item-thumbnail"><div class="preloading"></div><img tabindex="-1" src="'+t.thumbnail+'" title="'+t.title+'" referrerpolicy="no-referrer" loading="lazy"></div>':"")+'<div class="'+o.options.classPrefix+'playlist-item-content"><div class="'+o.options.classPrefix+'playlist-item-title">'+t.title+" "+(0<t.textTracks.length?'<i class="eva eva-message-square"></i>':"")+' <i class="eva eva-volume-up-outline"></i></div>'+(null!==t.description&&0<t.description.length?'<span class="'+o.options.classPrefix+'playlist-item-description">'+t.description+"</span>":"")+"</div>"+(t.last_edited_date_str?'<div class="'+o.options.classPrefix+'playlist-item-lastedited"><div><span class="'+o.options.classPrefix+'playlist-item-lastedited-date">'+t.last_edited_date_str+'</span> <span class="'+o.options.classPrefix+'playlist-item-lastedited-time">'+t.last_edited_time_str+"</span></div></div>":"")+(!1!==t.purchaselink?'<a target="_blank" href="'+t.purchaselink+'" class="'+o.options.classPrefix+'playlist-item-purchase" title='+mejs.i18n.t("mejs.purchase")+'><i class="eva eva-shopping-cart eva-lg"></i></a>':"")+(!1!==t.download?'<a target="_blank" href="'+t.download+'" class="'+o.options.classPrefix+'playlist-item-download" title='+mejs.i18n.t("mejs.download-file")+'><i class="eva eva-download eva-lg"></i></a>':"")+"</div>",o.listItems.push(l.outerHTML),i.appendChild(l)}),e=0,s=[],o.playlistLayer.querySelectorAll("."+o.options.classPrefix+"playlist-selector-list-item:not(."+o.options.classPrefix+"playlist-selector-list-item-folder-header)").forEach(function(t){s[e]=o.playlist[t.getAttribute("data-playlist-index")],t.setAttribute("data-playlist-index",e),e++}),o.playlist=s,null===(t=o.playlistLayer.querySelector("li[data-depth='0']"))&&(t=o.playlistLayer.querySelector("."+o.options.classPrefix+"playlist-selector-list-item[data-playlist-index='0']")),t=parseInt(t.getAttribute("data-playlist-index")),o.currentPlaylistItem=t)},loadPlaylistItem:function(t,e,l){var s=this,i=s.playlistLayer.querySelector("."+s.options.classPrefix+"playlist-selected"),a=s.playlistLayer.querySelector("."+s.options.classPrefix+"playlist-selector-list-item[data-playlist-index='"+t+"']");s.isVideo&&!0===s.options.autoClosePlaylist&&mejs.Utils.toggleClass(s.playlistLayer,s.options.classPrefix+"playlist-hidden"),mejs.Utils.removeClass(i,s.options.classPrefix+"playlist-selected"),mejs.Utils.addClass(a,s.options.classPrefix+"playlist-selected"),s.openPlaylistSubFolders(a),s.currentPlaylistItem===t&&!0!==e||(s.currentPlaylistItem=t,s.options.googleAnalyticsTitle=s.playlist[t].title+(null!==s.playlist[t].description?" | "+s.playlist[t].description:""),s.setSrc(s.playlist[t].src),s.setPoster(s.playlist[t].poster),s.scrollItemInView(),s.adsCurrentMediaUrl=s.playlist[t].src,void 0!==s.adsDataIsLoading&&!0===s.adsDataIsLoading||(void 0!==s.playerDownloadButton&&(!1===s.playlist[s.currentPlaylistItem].download?s.playerDownloadButton.style.display="none":s.playerDownloadButton.style.display="inline-block"),s.load(),(s.node.getAutoplay()||l)&&s.play().then(()=>{}).catch(t=>{!1===navigator.userActivation.hasBeenActive&&s.setMuted(!0),s.play().then(()=>{}).catch(t=>{s.setMuted(!1)})}),s.options.features.forEach(function(t){"speed"!==t||void 0!==s.speedButton?"ads"===t&&s.adsPlayerHasStarted&&(s.adsLoaded=!1,s.options.indexPreroll=0,s.options.adsPlayerHasStarted=!1,s.adsDataIsLoading=!1,s.buildads(s,s.getElement(s.controls),s.getElement(s.layers))):s.buildspeed(s,s.getElement(s.controls),s.getElement(s.layers),s.media)})),s.loadPlaylistTracks(s.currentPlaylistItem))},loadPlaylistTracks:function(t){var s=this,t=s.playlist[t].textTracks;s.trackFiles=[],0<t.length&&t.forEach(function(t,e){var l=document.createElement("track");l.kind=t.kind,l.label=t.label,l.src=t.src,l.srclang=t.srclang,s.trackFiles.push(l)}),setTimeout(function(){s.rebuildtracks(),s.changeLayout(),s.findTracks(),s.loadTrack(0),s.tracks.forEach(function(t,e){if(""===s.options.startLanguage||null===s.options.startLanguage||t.srclang===s.options.startLanguage)return s.setTrack(t.trackId)})},1e3)},openPlaylistSubFolders:function(t){for(var e=t.parentNode;e.classList.contains(this.options.classPrefix+"playlist-selector-list-item-folder-hidden");)e.previousSibling.click(),e=e.parentNode},changeLayout:function(){var t,e=this;void 0===e.leftcontrols&&(t=document.createElement("div"),l=document.createElement("div"),mejs.Utils.addClass(t,e.options.classPrefix+"controls-left"),mejs.Utils.addClass(l,e.options.classPrefix+"controls-right"),e.controls.appendChild(t),e.controls.appendChild(l),e.leftcontrols=t,e.rightcontrols=l);var l=e.controls.querySelectorAll(".wpcp__prev-button, .wpcp__playpause-button, .wpcp__next-button, .wpcp__volume-button, .wpcp__horizontal-volume-slider, .wpcp__currenttime-container, .wpcp__time, wpcp__duration-container");e.isVideo||(l=e.controls.querySelectorAll(".wpcp__prev-button, .wpcp__playpause-button, .wpcp__next-button, .wpcp__currenttime-container, .wpcp__time, wpcp__duration-container")),l.forEach(function(t){e.leftcontrols.appendChild(t)});l=e.controls.querySelectorAll(".wpcp__skip-back-button, .wpcp__jump-forward-button, .wpcp__speed-button, .wpcp__shuffle-button, .wpcp__loop-button, .wpcp__deeplink-button, .wpcp__share-button, .wpcp__download-button, .wpcp__fullscreen-button, .wpcp__zip-button, .wpcp__playlist-button, .wpcp__captions-button, .wpcp__chromecast-button, .wpcp__airplay-button");e.isVideo||(l=e.controls.querySelectorAll(".wpcp__skip-back-button, .wpcp__jump-forward-button, .wpcp__speed-button, .wpcp__shuffle-button, .wpcp__loop-button, .wpcp__deeplink-button, .wpcp__share-button, .wpcp__download-button, .wpcp__volume-button, .wpcp__horizontal-volume-slider, .wpcp__fullscreen-button, .wpcp__zip-button, .wpcp__playlist-button, .wpcp__captions-button, .wpcp__chromecast-button, .wpcp__airplay-button")),l.forEach(function(t){e.rightcontrols.appendChild(t)}),e.playlistLayer.parentNode!==e.container.parentNode&&e.container.parentNode.appendChild(e.playlistLayer)}})},{}]},{},[1]),!navigator.userActivation){navigator.userActivation={hasBeenActive:!1};let e=t=>{t.isTrusted&&(navigator.userActivation.hasBeenActive=!0,window.removeEventListener("click",e))};window.addEventListener("click",e)}
