...
define( 'WOOFIC_ENDPOINT_USERNAME', 'ck_79d1e1723da74eb781a125d0bb5a21c3033179cd' );
define( 'WOOFIC_ENDPOINT_PASSWORD', 'cs_3d06ad423100839c101c7c4954622f5c9fc2ad66' );
		...
		static function () {
			echo wp_kses_post(
				sprintf(
					...
					__( '"WooFic" requires PHP 5.6 or newer.', W_TEXTDOMAIN )
				)
			);
		}
	);
